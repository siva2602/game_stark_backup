        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    ...
                    <a class="btn btn-dark btn-sm" href="/videos/create-video">{{ __('Create Campaign')}}</a>
                    <div class="dropdown" style="position: absolute; right: 0; margin-right:30px; margin-top:-30px;">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                <a class="dropdown-item" href="#" id="enable" data-id="video">{{ __('Enable')}}</a>
                                <a class="dropdown-item" href="#" id="disable" data-id="video">{{ __('Disable')}}</a>                       
                                <a class="dropdown-item" href="#" id="delete" data-id="video">{{ __('Delete')}}</a>
                            </div>
                        </div> 
                        </h3></div>
                    <div class="card-body">
