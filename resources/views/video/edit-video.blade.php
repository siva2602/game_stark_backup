                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                          <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="url" type="text" class="form-control @error('url') is-invalid @enderror" value="{{$video->url}}"  placeholder="eg : http://youtu.be/dQw4w9WgXcQ" required>
                        ...
                        <input type="hidden" name="url" id="seturl" value="{{$video->url}}"/>
                        <input type="hidden" name="thumb" id="setthumb" value="{{$video->thumb}}"/>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="coin" type="number" class="form-control" name="task_limit" value="{{$video->task_limit}}" placeholder="Count of Users, who will Watch Video" required>
                                </div>
                            </div> 
