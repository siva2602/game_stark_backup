        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="/quiz/create" enctype= "multipart/form-data">
                        @csrf
                          ...
                          <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input id="icon" type="text" class="form-control" name="question" placeholder="Question" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                     <input id="name" type="text" class="form-control" name="a" value="" placeholder="Option A" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                     <input id="name" type="text" class="form-control" name="b" value="" placeholder="Option B" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                     <input id="name" type="text" class="form-control" name="c" value="" placeholder="Option C" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                     <input id="name" type="text" class="form-control" name="d" value="" placeholder="Option D" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                     <input id="name" type="text" class="form-control" name="answer" value="" placeholder="Right Answer" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                     <input id="name" type="text" class="form-control" name="coin" value="" placeholder="Coin " required>
