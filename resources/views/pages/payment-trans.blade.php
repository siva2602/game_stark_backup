...
@section('content')
    ...
    <div class="container-fluid">
                ...
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            ...
                            <span>{{ __('List of Payment Transaction')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                     <div class="card-header"><h3>{{ __('Payment Transaction')}}</h3> <span style="position: absolute; right: 0; margin-right:300px; margin-top:-30px;" class="badge badge-dark"></span>
    ...
    <script>
        ...
        var dTable = $('#trans_table').DataTable({
            ...
            columns: [
                ...
                {data:'trans_id', name: 'trans_id'}, // add column name
                {data:'coin', name: 'coin'},
                {data:'amount', name: 'amount'},
                {data:'status', name: 'status'}, // add column name
                {data:'pacinfo', name: 'pacinfo'}, // add column name
