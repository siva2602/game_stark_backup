            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Api Offerwalls')}}</h5>
                            <span>{{ __('List of Api Offerwalls')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card p-3">
                    ...
                    <a class="btn btn-dark btn-sm" href="/offerwall/create-offer-api">{{ __('Add Network')}}</a>
